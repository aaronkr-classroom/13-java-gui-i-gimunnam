...
public class ex1402  {
	...
	public static void main(String[] args) {
		...
		frame.add(panel);
		//버튼 추가하기
		JButton btn1 = new JButton("COKE cola", new ImageIcon("img/콜라.jpg"));
		JButton btn2 = new JButton("Diet COKE", new ImageIcon("img/콜라.jpg"));
		JButton btn3 = new JButton("COKE ZERO", new ImageIcon("img/콜라.jpg"));
		btn1.setSize(64, 64);
		btn2.setSize(64, 64);
		btn3.setSize(64, 64);
		...
		JRadioButton rbtn5 = new JRadioButton("5학년");
		...
		panel.add(uname);
		JLabel pwrdLbl = new JLabel("password:");
		panel.add(pwordLb1);
		JTextField uname = new JTextField(10);	
		panel.add(uname);
